...
<div class="comment-wrapper-respond form-horizontal">
	...
	$fields =  array(
			...
			'<label for="author" class="control-label">' . __( '*Name','easel' ) .'</label><div class="controls"><input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" /></div></div>',
			'email'  => '<div class="comment-form-email control-group">' .
			'<label for="email" class="control-label">' . __( '*Email', 'easel' ) . '<small> &mdash; <a href="http://gravatar.com">'. __('Get a Gravatar','easel') . '</a></small></label><div class="controls"><input id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" /></div> </div>',
			'url'    => '<div class="comment-form-url control-group">' .
			'<label for="url" class="control-label">' . __( 'Website URL', 'easel' ) . '</label><div class="controls"><input id="url" name="url" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" /></div></div>',
			);
	$args = array(
